...
<nav class="navbar navbar-expand-lg bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand text-black" href="#">IA - Global Project - ASIX2</a>
    ...
    <h1>Página de Instalación</h1>
    <h3>Instalación del software</h3>
        <p>Para realizar la configuración DHCP, asegúrate de tener instalado el software necesario.</p>
